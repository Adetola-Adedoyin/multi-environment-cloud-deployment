...
module "storage" {
  ...
  k8s_master_count          = var.k8s_master_count
  k8s_worker_count          = var.k8s_worker_count
  management_instance_ids   = module.compute.management_instance_ids
  k8s_master_instance_ids   = module.compute.k8s_master_instance_ids
  k8s_worker_instance_ids   = module.compute.k8s_worker_instance_ids
}